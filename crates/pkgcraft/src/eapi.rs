...
pub static EAPI5: LazyLock<Eapi> = LazyLock::new(|| {
    ...
    Eapi::new("5", None)
        ...
        .update_commands([
            ...
            Command::new(pkg_config, [All]),
            Command::new(pkg_info, [All]),
            Command::new(pkg_nofetch, [All]),
            Command::new(pkg_postinst, [All]),
            Command::new(pkg_postrm, [All]),
            Command::new(pkg_preinst, [All]),
            Command::new(pkg_prerm, [All]),
            Command::new(pkg_pretend, [All]),
            Command::new(pkg_setup, [All]),
            Command::new(src_compile, [All]),
            Command::new(src_configure, [All]),
            Command::new(src_install, [All]),
            Command::new(src_prepare, [All]),
            Command::new(src_test, [All]),
